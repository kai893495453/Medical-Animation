...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='nav-list.php'"><i class="icon-list"></i> 导航列表</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form action="addNav.php" method="post">
            <label>栏目标题</label>
            <input type="text" value="" class="input-xlarge" name="data[name]">
            <label>访问路径</label>
            <input type="text" value="" class="input-xlarge" name="data[alink]">
            <input type="hidden" name="data[fid]" value="<?php echo $_GET['id']; ?>">
            <label></label>
