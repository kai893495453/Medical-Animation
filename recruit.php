      ...
      <div class="list">
            ...
            <dl>
                ...
                <dd>
                	<ol class="signUp">
                    	<li>1、报名时间
                        	<p>2013年9月10日-2013年9月28日</p>
                        </li>
                    	<li>2、报名方式
                        <ul class="orderList">
                        	<li>本公告刊登在蚌埠市旭阳医疗动漫科技有限公司网站，应聘者可登陆网站进行报名。 </li>
                            <li>联系人：郭先生；联系电话：（020）1234567</li>
                            <li>http://career.xuyangyiliao.com.cn/gcgs02/UserLogin.aspx</li>
                        </ul>
                        </li>
                    	<li>3、报名要求
                        	<p>参加笔试时提供以下材料：身份证、学历／学位证、职业资格证书等相关资料的原件及复印件。</p>
                        </li>
                    	<li>4、招聘程序
                        	<p>报名-资格初审-笔试-面试-发录取函-试用-正式录用。</p>
                        </li>
                    	<li>5、说明
                        <ul class="orderList">
                        	<li>（1）我们承诺为应聘人员保密所有信息资料；</li>
                            <li>（2）应聘人员应对提交材料的真实性负责，凡弄虚作假者，一经查实，取消应聘资格；</li>
                            <li>（3）以上条款由蚌埠市旭阳医疗动漫科技有限公司人力资源部负责解释。</li>
                        </ul>
                        </li>
                    </ol>
                </dd>
