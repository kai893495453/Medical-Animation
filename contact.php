...
<main>
  <div class="content w1000 mAuto">
    ...
    <div class="fr content-main">
      <article class="breadcrumbs f12">当前位置： <a href="index.php">首页</a> > <a href="#">走进我们</a> > <a href="#"> 联系旭阳</a></article>
      <div class="line"></div>
      <div class="list">
        <ul>
          <li><img src="images/icon/address.png" align="absmiddle">地 址：广州市天河区燕岭路120号金燕大厦502</li>
          <li><img src="images/icon/mail.png" align="absmiddle">邮 箱:123456789@qq.com</li>
          <li><img src="images/icon/telphone.png" align="absmiddle">联系电话:440-009-9778</li>
          <li><img src="images/icon/fax.png" align="absmiddle">传 真:1245678978978</li>
        </ul>
        <div class="map">
