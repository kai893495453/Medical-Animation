<?php
  $arrNav = array('增强免疫力','辅助降血脂','辅助降血糖','抗氧化、延缓衰老','辅助改善记忆力 ','辅助降血压','抗辐射','减肥','增加骨密度','提高缺氧耐受力','促进排铅','改善睡眠');
  $arr = array(
    0=>array(
      'date'=>'2015-8-04',
      'title'=>'成年人是否需要补充维生素D？',
	...
	<div class="content w1000 mAuto">
    	<div class="fl content-tag">
            ...
            <div class="subtag">
                ...
                <div class="active"><a href="health-assort.php">按功效分类</a></div>
            </div>
        	<div class="cb"></div>
        </div>
    	<div class="fr content-main">
        	<article class="breadcrumbs f12">当前位置：  <a href="index.php">首页</a>  >  <a href="#">营养保健</a>  >  <a href="#">  按功效分类</a></article>
            <div class="line"></div>
            <div class="list mAuto">
            	<div class="filter">
                <?php foreach($arrNav as $key => $value): ?>
                	<a class=<?php if($key==0)echo "active";?> href="#"><?php echo $value; ?></a>
                <?php endforeach; ?>
                  <div class="cb"></div>
                </div>
